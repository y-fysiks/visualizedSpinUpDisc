...
/**
 * The class Frisbee contains the method simulate which uses Euler&rsquo;s
...
class FrisbeeTest{
    ...
    private static final double CD0 = 0.08; //The drag coefficient at alpha = 0.
     ...
     *
     */
    public static ArrayList<double[]> simulate(double y0, double vx0, double vy0, double a, double deltaT) {
        double alpha = a;
        instance++;
...
class calcConstants{
    ...
    public ArrayList<double[]> runSim(){
        return FrisbeeTest.simulate(launchHeight, xVelocity, yVelocity, angleOfAttack, 0.001);
